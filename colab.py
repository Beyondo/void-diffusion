...
def init(ModelName):
    ...
    if not torch.cuda.is_available():
        ...
        try:
            ...
            # CLIPTextConfig
            config = CLIPTextConfig.from_pretrained("laion/CLIP-ViT-B-32-laion2B-s34B-b79K", torch_dtype=torch.float16) # This gives me an error: "Input type (float) and bias type (c10::Half) should be the same" when I try to diffuse an image.
