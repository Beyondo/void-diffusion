...
def convert_checkpoint(checkpoint_path, original_config_file=None, num_in_channels=None, 
    ...
    config = load_pipeline_from_original_stable_diffusion_ckpt(args.original_config_file)
...
def from_pretrained(checkpoint_path, is_img2img=False):
    ...
    pipe = None
    try:
        pipe = convert_checkpoint(checkpoint_path, is_img2img, device="cuda")
